...
// return (
//   <>
//     <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-8 text-orange-500 bg-gray-800'></div>
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center">
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-8 text-orange-500 bg-gray-800">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          ...
          />
          <button 
          onClick={copyPasswordToClipboard}className='outline-none bg-blue-700 text-white px-3 py-3 shrink-0 '>copy</button>
        </div>
